import { View, Text, Switch, FlatList, Image, TouchableOpacity, Modal, TextInput, Button, ToastAndroid, Alert, BackHandler } from 'react-native'
...
const Home = () => {
  ...
  const toggleSwitch = async (index: any) => {
    ...
    const filterData = tempData.filter(tempData => tempData.isEnabled).map(item => item.name).join(', ');;
    console.log('filterData', filterData)
    await AsyncStorage.setItem('Notification Data', JSON.stringify(filterData));
